		...
		if ( class_exists( 'DGWT_WC_Ajax_Search' )){
			machic_customizer_add_field (
				array(
					...
					'label' => esc_attr__( 'Ajax Search Form Search Holder', 'machic' ),
					'description' => esc_attr__( 'Replace the search bar which is on the search holder.', 'machic' ),
					'section' => 'machic_header_general_section',
					'default' => '0',
					'required' => array(
						array(
	...
	/*====== SHOP ====================================================================================*/
		...
		machic_customizer_add_field (
			array(
				...
				'label' => esc_attr__( 'Perpage View', 'machic' ),
				'description' => esc_attr__( 'Disable or Enable perpage view on shop page.', 'machic' ),
				'section' => 'machic_shop_general_section',
				'default' => '0',
			)
		);

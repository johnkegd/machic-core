...
final class Machic_Elementor_Addons
{
    ...
    */
    public function init_widgets()
    {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Home_Slider_Widget() );
		
		// Custom Title
		require_once( __DIR__ . '/elementor/widgets/machic-custom-title.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Custom_Title_Widget() );
		
		// Clients Box
		require_once( __DIR__ . '/elementor/widgets/machic-clients-box.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Clients_Box_Widget() );
		
		// Banner Box
		require_once( __DIR__ . '/elementor/widgets/machic-banner-box.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Banner_Box_Widget() );
		
		// Banner Box2
		require_once( __DIR__ . '/elementor/widgets/machic-banner-box2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Banner_Box2_Widget() );
		
		// Banner Box3
		require_once( __DIR__ . '/elementor/widgets/machic-banner-box3.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Banner_Box3_Widget() );
		
		// Icon List
		require_once( __DIR__ . '/elementor/widgets/machic-icon-list.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Icon_List_Widget() );

		// Product Grid
		require_once( __DIR__ . '/elementor/widgets/machic-product-grid.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Product_Grid_Widget() );

		// Deals Product
		require_once( __DIR__ . '/elementor/widgets/machic-deals-product.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Deals_Product_Widget() );
		
		// Text Banner
		require_once( __DIR__ . '/elementor/widgets/machic-text-banner.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Text_Banner_Widget() );
		
		// Text Banner
		require_once( __DIR__ . '/elementor/widgets/machic-text-banner2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Text_Banner2_Widget() );
		
		// Category Banner
		require_once( __DIR__ . '/elementor/widgets/machic-category-banner.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Category_Banner_Widget() );
		
		// Category Banner 2
		require_once( __DIR__ . '/elementor/widgets/machic-category-banner2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Category_Banner2_Widget() );
		
		// Category Banner 3
		require_once( __DIR__ . '/elementor/widgets/machic-category-banner3.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Category_Banner3_Widget() );

		// Product Categories
		require_once( __DIR__ . '/elementor/widgets/machic-product-categories.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Product_Categories_Widget() );
		
		// Counter Product
		require_once( __DIR__ . '/elementor/widgets/machic-counter-product.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Counter_Product_Widget() );
		
		// Counter Product2
		require_once( __DIR__ . '/elementor/widgets/machic-counter-product2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Counter_Product2_Widget() );

		// Product List
		require_once( __DIR__ . '/elementor/widgets/machic-product-list.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Product_List_Widget() );
		
		// Product List 2
		require_once( __DIR__ . '/elementor/widgets/machic-product-list2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Product_List2_Widget() );
		
		// Product Carousel
		require_once( __DIR__ . '/elementor/widgets/machic-product-carousel.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Product_Carousel_Widget() );

		// Icon Box
		require_once( __DIR__ . '/elementor/widgets/machic-icon-box.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Icon_Box_Widget() );
		
		// Counter 
		require_once( __DIR__ . '/elementor/widgets/machic-counter.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Counter_Widget() );
		
		// Text Block 
		require_once( __DIR__ . '/elementor/widgets/machic-text-block.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Text_Block_Widget() );
		
		// Address Box
		require_once( __DIR__ . '/elementor/widgets/machic-address-box.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Address_Box_Widget() );
		
		// Contact Form 7
		require_once( __DIR__ . '/elementor/widgets/machic-contact-form-7.php' );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Contact_Form_7_Widget() );
		
		// Vendor Grid
		if (function_exists('get_wcmp_vendor_settings')) {
			require_once( __DIR__ . '/elementor/widgets/machic-vendor-grid.php' );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\Machic_Vendor_Grid_Widget() );
		}
	}

...
## Scripts
*************************************************/
function machic_product_data_video_scripts() {
...
add_action( 'wp_enqueue_scripts', 'machic_product_data_video_scripts' );
...
add_action('woocommerce_product_data_panels', function() {
	...
	woocommerce_wp_textarea_input([
		...
		'label' => esc_html__('Video URL', 'machic-core'),
		'wrapper_class' => 'show_if_simple',
		'desc_tip'    => true,
		'description' => esc_html__( 'Enter a youtube or a vimeo video url for the single product.', 'machic-core' ),
	]);
...
function klb_product_data_video(){
	...
	if($videourl){
		...
		echo '<div class="klb-single-video"><a class="'.esc_attr($videoclass).'" href="'.esc_url($videourl).'"><span>'.esc_html__('Watch video','machic-core').'</span></a></div>';

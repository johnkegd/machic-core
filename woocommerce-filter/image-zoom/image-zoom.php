<?php
if(get_theme_mod('machic_single_image_zoom') == 1 || machic_ft() == 'imgzoom'){
	
/*************************************************
## Scripts
*************************************************/
function machic_image_zoom_scripts() {
...
add_action( 'wp_enqueue_scripts', 'machic_image_zoom_scripts' );
...
function machic_image_zoom_setup() {
	add_theme_support( 'wc-product-gallery-zoom' );
}
add_action( 'after_setup_theme', 'machic_image_zoom_setup' );
